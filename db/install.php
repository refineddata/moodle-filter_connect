...
/**
 * Connect filter post install hook
 *
 * @package    filter
 * @subpackage connect
...
function xmldb_filter_connect_install() {
    global $CFG, $DB;
    ...
    $table->add_field( 'ctype', XMLDB_TYPE_CHAR,    '10',  null, XMLDB_NOTNULL, null, null );
    $table->add_field( 'ckey',  XMLDB_TYPE_CHAR,    '100', null, XMLDB_NOTNULL, null, null );
    ...
    $table->add_index( 'type-key', XMLDB_INDEX_NOTUNIQUE, array( 'ctype', 'ckey' ) );
    ...
    if ( empty( $CFG->connect_nosso ) OR !$CFG->connect_nosso ) {
        ...
        $field = new xmldb_field( 'aclogin', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'password' );
        if ( !$dbman->field_exists( $table, $field ) ) $dbman->add_field( $table, $field );

        $field = new xmldb_field( 'ackey', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, null, 'aclogin' );
        if ( !$dbman->field_exists( $table, $field ) ) $dbman->add_field( $table, $field );

        // Add Timezones
        $table = new xmldb_table( 'connect_timezones' );
        $table->add_field( 'id',               XMLDB_TYPE_INTEGER, '10',  XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_SEQUENCE, null );
        $table->add_field( 'name',             XMLDB_TYPE_CHAR,    '100', null, XMLDB_NOTNULL, null, null );
        $table->add_field( 'gmtoff',           XMLDB_TYPE_INTEGER, '10',  null, XMLDB_NOTNULL, null, '0' );
        $table->add_field( 'connect_timezone', XMLDB_TYPE_INTEGER, '10',  null, XMLDB_NOTNULL, null, '0' );
