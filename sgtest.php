...
function get_pack_link($os_alias, $ext, $text = ''){
 ...
 if (function_exists("sg_load")){
  	if (function_exists("sg_get_const")){
  		if(version_compare(sg_get_const("version"),$LOADER_VER_REQUIRED,'>')){
  			echo "SourceGuardian loaders are already installed."."\n";
  			exit;
  		}
  		else echo "Old SourceGuardian loader is already installed, you need to upgrade it to latest version."."\n";
  		exit;
  	}
